...
kvs = KafkaUtils.createDirectStream(ssc, ["humidityanalytics"], {"metadata.broker.list": "172.18.0.2:6667"})
...
# Average humidity of each medicalimagingdevice 
...
# Number of devices in each medicalimagingdevice
numSensorsByState = jsonRDD.map(lambda x: (x['medicalimagingdevice'] + ":" + x['guid'], 1)) \
